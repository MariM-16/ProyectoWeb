class ResponsesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @response.save
        format.html { redirect_to ticket_url(@response.ticket_id), notice: "Response was successfully created." }
  ...
  private
    ...
    def response_params
      params.fetch(:response, {}).permit(:user_id, :response, :response_date, :ticket_id)
    end
end
