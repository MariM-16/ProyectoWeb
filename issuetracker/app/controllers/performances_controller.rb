class PerformancesController < ApplicationController
  ...
  def index
    ...
    @executive=Performance.select(:executive_id)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @performance.save
        format.html { redirect_to ticket_url(@performance.ticket_id), notice: "Performance was successfully created." }
  ...
  private
    ...
    def performance_params
      params.fetch(:performance, {}).permit(:user_id, :executive_id, :evaluation, :ticket_id)
    end
end
