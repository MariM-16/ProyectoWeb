...
p1 = Performance.create(user_id:1, executive_id:4, evaluation:1)
p2 = Performance.create(user_id:1, executive_id:5, evaluation:2)
p3 = Performance.create(user_id:2, executive_id:4, evaluation:3)
p4 = Performance.create(user_id:2, executive_id:5, evaluation:4)
p5 = Performance.create(user_id:2, executive_id:4, evaluation:5)
p6 = Performance.create(user_id:2, executive_id:4, evaluation:5)
